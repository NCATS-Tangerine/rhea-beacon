...
def get_concept_details(concept_id):  # noqa: E501
    ...
    """
    return ctrl.get_concept_details(concept_id=concept_id)
...
def get_concepts(keywords=None, categories=None, offset=None, size=None):  # noqa: E501
    ...
    """
    return ctrl.get_concepts(keywords=keywords, categories=categories, offset=offset, size=size)
...
def get_exact_matches_to_concept_list(c):  # noqa: E501
    ...
    """
    return ctrl.get_exact_matches_to_concept_list(c=c)
